...
PointLight::PointLight(GLuint shadowWidth, GLuint shadowHeight,
	...
	GLfloat rad) : Light(shadowWidth, shadowHeight, red, green, blue, aIntensity, dIntensity)
{
...
std::vector<glm::mat4> PointLight::CalculateLightTransform()
{
	...
	// We actually use 6 perspeective view from each sides of the point light
	// This is for the ShadowMap
